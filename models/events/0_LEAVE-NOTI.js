...
module.exports.run = async function({ api, event, Users, Threads }) {
  ...
  const axios = global.nodemodule["axios"];
	...
	const type = (event.author == event.logMessageData.leftParticipantFbId) ? "खुद ही भाग गया 😐👈" : "एडमिन ने निकाल दिया 😑👈";
  (typeof data.customLeave == "undefined") ? msg = "✧════•❁𝗚𝗢𝗢𝗗𝗕𝗬𝗘❁•════✧\n\nसुकर है एक ठरकी इस ग्रुप में कम हो गया 😆\nउसका नाम है 𒁍 {name}\nरीजन 𒁍 {type}\n════════════════════════ ❁\n𝐎𝐰𝐧𝐞𝐫 𝐀𝐲𝐚𝐧𝐬𝐡፝֟፝֟ ✭⃝🩷" : msg = data.customLeave;
